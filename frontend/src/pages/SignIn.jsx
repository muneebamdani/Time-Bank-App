...
// import { 
//   Container, Row, Col, Form, Button, Carousel, Image, Card, FormCheck 
...
import React, { useState } from 'react';
import { useNavigate } from 'react-router-dom';
import { Container, Row, Col, Form, Button, Carousel, Image, Card, FormCheck } from 'react-bootstrap';
import { Envelope, EyeFill, EyeSlashFill } from 'react-bootstrap-icons';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Normal JavaScript alert on success
        alert('Login successful');
        navigate('/');
      } else {
        // Normal JavaScript alert on error
        alert('Login failed');
      }
    } catch (error) {
      console.error('Error during login:', error);
